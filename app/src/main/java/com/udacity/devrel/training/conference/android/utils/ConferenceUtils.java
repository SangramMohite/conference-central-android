...
import com.appspot.manageconferences_156107.conference.model.Conference;
import com.appspot.manageconferences_156107.conference.model.ConferenceCollection;
import com.appspot.manageconferences_156107.conference.model.Profile;
import com.appspot.manageconferences_156107.conference.model.WrappedBoolean;
...
public class ConferenceUtils {
    ...
    private static com.appspot.manageconferences_156107.conference.Conference sApiServiceHandler;
     ...
     * This list includes information about what {@link com.appspot.manageconferences_156107.conference.model.Conference}s
    ...
    public static List<DecoratedConference> getConferences()
        ...
        com.appspot.manageconferences_156107.conference.Conference.QueryConferences
    ...
    /**
     * Registers user for a {@link com.appspot.manageconferences_156107.conference.model.Conference}
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean registerForConference(Conference conference)
        ...
        com.appspot.manageconferences_156107.conference.Conference.RegisterForConference
    ...
    /**
     * Unregisters user from a {@link com.appspot.manageconferences_156107.conference.model.Conference}.
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean unregisterFromConference(Conference conference)
        ...
        com.appspot.manageconferences_156107.conference.Conference.UnregisterFromConference
    ...
    /**
     * Returns the user {@link com.appspot.manageconferences_156107.conference.model.Profile}. Can
    ...
    public static Profile getProfile() throws ConferenceException, IOException {
        ...
        com.appspot.manageconferences_156107.conference.Conference.GetProfile getProfile =
                sApiServiceHandler.getProfile();
        return getProfile.execute();
    }

    /**
     * Build and returns an instance of {@link com.appspot.manageconferences_156107.conference.Conference}
     *
     * @param context
     * @param email
     * @return
     */
    public static com.appspot.manageconferences_156107.conference.Conference buildServiceHandler(
            Context context, String email) {
        GoogleAccountCredential credential = GoogleAccountCredential.usingAudience(
                context, AppConstants.AUDIENCE);
        credential.setSelectedAccountName(email);

        com.appspot.manageconferences_156107.conference.Conference.Builder builder
                = new com.appspot.manageconferences_156107.conference.Conference.Builder(
                AppConstants.HTTP_TRANSPORT,
                AppConstants.JSON_FACTORY, credential);
        Log.e(TAG, "******************************************************************************");
        Log.e(TAG, email);
        Log.e(TAG, credential.toString());
        Log.e(TAG, AppConstants.AUDIENCE);
        Log.e(TAG, "******************************************************************************");
